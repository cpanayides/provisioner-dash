...
exports.assets = function(req, res){
  //console.log(_.map(s,function(x){ return Asset(x); }));
  res.send(_.map(s,function(x){ return Asset(x); }));
};
//TODO: this is totally lame. needs to be fixed to make some kind of normalized Asset model
/*
exports.assets = function(req, res){
  collins.assets({size: 1000, status: "provisioning"}, function(resp){
    var d = '';
    ...
    console.err("Encountered an error: " + e.message);
    throw e;
  });
};
*/
